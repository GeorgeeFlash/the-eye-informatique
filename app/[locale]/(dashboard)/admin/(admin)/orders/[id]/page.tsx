              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  ...
                  <p className="font-medium">
                    {(order as { user?: { name?: string | null } }).user
                      ?.name ?? "-"}
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    {(order as { user?: { email?: string | null } }).user
                      ?.email ?? "-"}
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    {formatDate(order.createdAt, "dd/MM/yyyy HH:mm", locale)}
                  </p>
                </div>
                <div>
                  <span className="text-muted-foreground">
                  ...
                  {order.items.map((item) => (
                    <TableRow key={item.id}>
                      ...
                      <TableCell>
                        <Badge
                          variant={
                            FULFILLMENT_VARIANT[item.fulfillmentStatus] ??
                            "outline"
                          }
                          className="text-xs"
                        >
              ...
              <div className="flex justify-end">
                <div className="w-64 space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {formatCurrency(Number(order.deliveryFee), locale)}
                    </span>
                  </div>
                  <Separator />
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    <p>
                      <Badge
                        variant={
                          PAYMENT_VARIANT[order.payment.status] ?? "outline"
                        }
                      >
                    ...
                    {order.installments.map((inst) => (
                      <TableRow key={inst.id}>
                        ...
                        <TableCell>
                          ...
                          >
                            {tOrders(
                              `installment${inst.status.charAt(0) + inst.status.slice(1).toLowerCase()}`,
                            )}
                          </Badge>
                        </TableCell>
                        <TableCell>
